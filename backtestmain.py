...
from btui import backtestui, backtest
import datetime
...
class QThread1(QThread):
    ...
    def run(self):
        backtest.beginPushed(self, input_info)
        

class MyWidget(QMainWindow, backtestui.Ui_MainWindow):
    ...
    def pushBegin(self):
        ...
        input_info = {'emp_ID':emp_ID, # A string
                      'proxy_id': None, # proxy_id, # A string
                      'proxy_pw':None, #proxy_pw, # A string
